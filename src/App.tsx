...
function App() {
  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <div className="min-h-screen md:container md:mx-auto lg:grid lg:grid-cols-2 lg:gap-8">
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="pt-[100px] px-8 md:pt-8 md:h-screen md:flex md:items-center"
        >
              ...
              <Typewriter
                ...
                onInit={(typewriter) => {
                  typewriter
                    ...
                    .pauseFor(500)
                    .typeString('<br>I blend data-driven insights with intuitive design to craft products that not only look great but also perform.')
                    .pauseFor(300)
        ...
        <AnimatePresence>
          {selection && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 20 }}
              className="mt-8 md:mt-0 lg:h-screen lg:flex lg:items-center"
            >
