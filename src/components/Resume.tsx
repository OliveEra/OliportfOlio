  ...
  const testimonials = [
    {
      ...
      image: "https://media.licdn.com/dms/image/v2/D5603AQE3Zt5Bkn8_Pw/profile-displayphoto-shrink_100_100/profile-displayphoto-shrink_100_100/0/1676371289401?e=1744848000&v=beta&t=iIxvg2meSLXGPbSEccZODBv28EDiLaXwttxxxcsqEL0"
    },
    {
      author: "Marek Holub",
    ...
    },
    {
      ...
      image: "https://media.licdn.com/dms/image/v2/D4D03AQEJne5CXQllRg/profile-displayphoto-shrink_100_100/profile-displayphoto-shrink_100_100/0/1678203843792?e=1744848000&v=beta&t=NKvTCVH6A496fnrH2CfGr2nRC1QI8BxV2cmJSqQJsjo"
    }
  ];
  ...
  return (
    <div className="h-full flex flex-col p-8">
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 mb-8 bg-white/10 backdrop-blur-md p-6 rounded-xl">
        <img
          src="https://media.licdn.com/dms/image/v2/D4E03AQG51tZRTGh2Qg/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1694696604631?e=1744848000&v=beta&t=QDbsbFbmwGqJCTCgDamICDDQ4iLINYFWqfn2Ui8bUbo"
          alt="Olivera Tomich"
